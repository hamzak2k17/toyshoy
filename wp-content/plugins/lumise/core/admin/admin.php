		...
		if (isset($do_action)) {
			switch ($do_action) {
				...
				case 'verify-license' : 
					...
					$key = 'B5E0B5-F8DD86-89E6AC-A49DD6-E6E1A-930';
					...
					if (!is_array($lumise_msg))
						...
						$this->main->set_option('purchase_key', 'B5E0B5-F8DD86-89E6AC-A49DD6-E6E1A-930');
				...
				case 'verify-license-addon-bundle' : 
					...
					$key_addon_bundle = 'B5E0B5-F8DD86-89E6AC-A49DD6-E6E1A-930';
				...
				case 'revoke-license-addon-bundle' : 
					...
					if (!is_array($lumise_msg))
						...
						$this->main->set_option('purchase_key_addon_bundle', 'B5E0B5-F8DD86-89E6AC-A49DD6-E6E1A-930');
						$lumise_msg['status'] = 'success';
						$lumise_msg['msg'] =$this->main->lang('Your purchase code has been revoked successful');
				...
				case 'verify-license-addon-vendor' : 
					...
					$key_addon_vendor = 'B5E0B5-F8DD86-89E6AC-A49DD6-E6E1A-930';
				...
				case 'revoke-license-addon-vendor' : 
					...
					if (!is_array($lumise_msg))
						...
						$this->main->set_option('purchase_key_addon_vendor', 'B5E0B5-F8DD86-89E6AC-A49DD6-E6E1A-930');
						$lumise_msg['status'] = 'success';
						$lumise_msg['msg'] =$this->main->lang('Your purchase code has been revoked successful');
